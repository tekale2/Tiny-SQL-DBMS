...
TinySql: StorageManager.o databaseEngine.o bufferManager.o whereEval.o parser.o helper.o
	$(cc) -o TinySql StorageManager.o databaseEngine.o whereEval.o bufferManager.o parser.o helper.o main.cpp
